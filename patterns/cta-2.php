...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","right":"20px","bottom":"64px","left":"20px"},"blockGap":"36px"}},"backgroundColor":"tertiary","layout":{"type":"constrained","contentSize":"1280px","wideSize":"1440px","justifyContent":"center"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:82%"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"36px","lineHeight":"1.2"}},"textColor":"primary"} -->
<p class="has-text-align-left has-primary-color has-text-color" style="font-size:36px;font-style:normal;font-weight:700;line-height:1.2">Unlock Exclusive Benefits by Joining Today!</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"18px","lineHeight":"1.5"}},"textColor":"primary"} -->
<p class="has-text-align-left has-primary-color has-text-color" style="font-size:18px;font-style:normal;font-weight:400;line-height:1.5">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
