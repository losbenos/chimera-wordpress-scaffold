...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/2200_538-m.svg","id":619,"dimRatio":70,"overlayColor":"contrast","align":"full"} -->
<div class="wp-block-cover alignfull"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-619" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/2200_538-m.svg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","right":"20px","bottom":"64px","left":"20px"},"blockGap":"24px"}},"layout":{"type":"constrained","contentSize":"1280px","wideSize":"1440px","justifyContent":"center"}} -->
...
<p class="has-text-align-center has-primary-color has-text-color" style="font-size:18px;font-style:normal;font-weight:400">Try PatternsWP Platform for 30 days. No credit card required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
