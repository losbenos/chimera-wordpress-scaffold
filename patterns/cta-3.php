...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/2200_538.svg","id":617,"dimRatio":70,"overlayColor":"contrast","minHeight":322,"minHeightUnit":"px","align":"full"} -->
<div class="wp-block-cover alignfull" style="min-height:322px"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-617" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/2200_538.svg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","right":"20px","bottom":"64px","left":"20px"},"blockGap":"36px"}},"layout":{"type":"constrained","contentSize":"1280px","wideSize":"1440px","justifyContent":"center"}} -->
