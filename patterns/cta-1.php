...
/**
 * Title: CTA 1
 * Slug: chimera-master/cta-pattern-1
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","right":"20px","bottom":"64px","left":"20px"},"blockGap":"24px"}},"backgroundColor":"tertiary","layout":{"type":"constrained","contentSize":"","wideSize":"","justifyContent":"center"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"36px","lineHeight":1.3}},"textColor":"primary"} -->
<p class="has-text-align-center has-primary-color has-text-color" style="font-size:36px;font-style:normal;font-weight:700;line-height:1.3">Take the First Step towards Success - Get Started on Your Journey!</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"18px"}},"textColor":"primary"} -->
<p class="has-text-align-center has-primary-color has-text-color" style="font-size:18px;font-style:normal;font-weight:400">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
